...
(function() {
  ...
  describe('Min-Max Numbers in a List: ', function () {
    ...
    describe('Return the min and max number in the list in a new list follows `[min, max]`', function () {
      ...
      it('should return [3, 40] for [6, 4, 20,40]', function () {
        expect(myApp.findMinMax([6, 4, 20,40])).toEqual([3, 40]);
      });
      ...
      it('should return [1, 99] for [78, 8, 68, 1,89,30,40,99]', function () {
        expect(findMinMax([78, 8, 68, 1,89,30,40,99])).toEqual([1,99]);
      });

      it('should return [50,999] for [823,720,540,450,900,1200,900,999,50]', function () {
        expect(findMinMax([823,720,540,450,900,1200,900,999,50])).toEqual([50,999]);
      });

      it('should return [8, 200] for [67, 62, 150, 44, 7, 78, 200, 68, 8]', function () {
        expect(findMinMax([4, 66, 6, 44, 7, 78, 8, 68, 2])).toEqual([8, 200]);
      });
